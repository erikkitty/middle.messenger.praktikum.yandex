...
function renderAuthForm() {
  ...
  try {
    ...
    Handlebars.registerPartial('auth-form/__input/auth-form__input', authInputHbs);
    Handlebars.registerPartial('auth-form/__button/auth-form__button', authButtonHbs);
    Handlebars.registerPartial('auth-form/__link/auth-form__link', authLinkHbs);

    const template = Handlebars.compile(authFormHbs);
    app.innerHTML = template({});

    import('./components/auth-form/auth-form.ts').then(() => {
...
function renderRegisterForm() {
  ...
  try {
    ...
    Handlebars.registerPartial('register-form/__input/register-form__input', regInputHbs);
    Handlebars.registerPartial('register-form/__button/register-form__button', regButtonHbs);
    Handlebars.registerPartial('register-form/__link/register-form__link', regLinkHbs);

    const template = Handlebars.compile(regFormHbs);
    app.innerHTML = template({});

    import('./components/register-form/register-form.ts').then(() => {
...
function renderChatPage() {
  ...
  try {
    ...
    import('./components/chat-page/chat-page.ts').then((m) => m.initChatPage?.()).catch(console.error);
  } catch (e) {
    const errDiv = document.createElement('div');
    errDiv.className = 'app-error';
    errDiv.textContent = `Ошибка: ${(e as Error).message}`;
...
function renderSettingsPage() {
  ...
  try {
    ...
    Handlebars.registerPartial('settings-page/__avatar/settings-page__avatar', settingsAvatarHbs);
    Handlebars.registerPartial('settings-page/__user-info/settings-page__user-info', settingsUserInfoHbs);
    Handlebars.registerPartial('settings-page/__links/settings-page__links', settingsLinksHbs);
    Handlebars.registerPartial('settings-page/__modal/settings-page__modal', settingsModalHbs);
    Handlebars.registerPartial('settings-page/__change-password/settings-page__change-password', settingsChangePasswordHbs);
    Handlebars.registerPartial('settings-page/__change-data/settings-page__change-data', settingsChangeDataHbs);
...
function showChangeDataView() {
  ...
  import('./components/settings-page/__change-data/settings-page__change-data.ts').then((m) => {
    m.initChangeData();
  }).catch(console.error);
}
...
function showChangePasswordView() {
  ...
  import('./components/settings-page/__change-password/settings-page__change-password.ts').then((m) => {
